  ...
  const defaultData = [
    {
      ...
      express:
        " What are you seeing, hearing or otherwise sensing? (facts only)",
    },
    {
      message: "and feeling",
    ...
    },
    {
      message: "because I",
      express:
        "What interpretations, wants, needs, memories or anticipations of yours support those feelings?",
    },
    {
    ...
    },
    {
      message: "so that",
      express:
        "What positive results will that action, information or commitment lead to in the future?",
    },
    {
      message: "so that",
      express:
